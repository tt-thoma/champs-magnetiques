...
def create_animation(
    ...
    **kwargs
    ...
    """
    if mode == '3d':
        return _create_3d_animation(frames_dir, output_file, framerate, crf, **kwargs)
        return _create_slice_animation(frames_dir, output_file, framerate, crf, prefix, **kwargs)
...
def _create_3d_animation(
    ...
    **kwargs
    ...
    return _create_slice_animation(frames_dir, output_file, framerate, crf, 'frame')
...
if __name__ == '__main__':
    ...
    create_animation(frames_dir, output_file, framerate=15, crf=20)
