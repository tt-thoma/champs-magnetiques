...
def main():
    ...
    output_dir = os.path.join(os.path.dirname(__file__), '..', 'champs_v4', 'results', 'normalized_demo')
    ...
    plt.tight_layout()
    save_path = os.path.join(output_dir, 'comparison_standard_vs_normalized.png')
    ...
    plt.tight_layout()
    save_path = os.path.join(output_dir, 'normalized_different_densities.png')
    plt.savefig(save_path, dpi=150, bbox_inches='tight')
    print(f"   Sauvegarde : {save_path}")
    plt.close()
    ...
    plt.tight_layout()
    save_path = os.path.join(output_dir, 'normalized_different_colormaps.png')
    plt.savefig(save_path, dpi=150, bbox_inches='tight')
    print(f"   Sauvegarde : {save_path}")
    plt.close()
    ...
    save_path = os.path.join(output_dir, 'normalized_optimal.png')
