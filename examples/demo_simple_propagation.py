...
def main():
    ...
    # Visualisation
    output_dir = os.path.join(os.path.dirname(__file__), '..', 'champs_v4', 'results', 'demo_simple')
    ...
    save_path = os.path.join(output_dir, 'propagation_vecteurs_normalises.png')
    ...
    save_path = os.path.join(output_dir, 'propagation_streamlines.png')
    plt.savefig(save_path, dpi=150, bbox_inches='tight')
    print(f"  Sauvegarde : {save_path}")
    plt.close()
    ...
    plt.tight_layout()
    save_path = os.path.join(output_dir, 'propagation_comparaison.png')
    plt.savefig(save_path, dpi=150, bbox_inches='tight')
    print(f"  Sauvegarde : {save_path}")
    plt.close()
