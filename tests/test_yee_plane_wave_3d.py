...
from champs_v4.fdtd_yee_3d import Yee3D, c0


class TestYeePlaneWave3D(unittest.TestCase):
    def test_plane_wave(self):
        ...
        self.assertGreater(max_val, 1e-6, 'Plane wave did not propagate (max sample too small)')
